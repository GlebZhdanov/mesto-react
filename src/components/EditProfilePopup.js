...
function EditProfilePopup(props) {
  ...
  return (
    <PopupWithForm name='profile' title='Редактировать профиль' nameForm='form-profile' onSubmit={handleSubmit} isOpen={props.isOpen} onClose={props.onClose} buttonText={"Сохранить"} >
